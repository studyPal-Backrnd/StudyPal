...
public interface UserService {
    ...
    UserResponse updateUser(Long userId, JsonPatch updatePayLoad);
    void updateUser(AppUser user);
    UserResponse uploadProfileImage(MultipartFile profileImage, Long userId) throws ImageUploadException;
